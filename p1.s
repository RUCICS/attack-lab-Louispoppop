...
0000000000401232 <func>:
  ...
  40123e:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)    ; base -> rbp-24
  401242:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx   
  401246:	48 8d 45 f8          	lea    -0x8(%rbp),%rax
  40124a:	48 89 d6             	mov    %rdx,%rsi           ; rsi = baseaddr
  40124d:	48 89 c7             	mov    %rax,%rdi           ; rdi = &(rbp-8)
  401250:	e8 5b fe ff ff       	call   4010b0 <strcpy@plt> 
  # strcpy(&(rbp-8), file_content)
  401255:	90                   	nop
  401256:	c9                   	leave
  401257:	c3                   	ret
...
0000000000401258 <main>:
  ...
  401267:	89 bd ec fe ff ff    	mov    %edi,-0x114(%rbp) ;argc -> rbp-280
  40126d:	48 89 b5 e0 fe ff ff 	mov    %rsi,-0x120(%rbp) ;argv -> rbp-288
  401274:	bf 14 20 40 00       	mov    $0x402014,%edi
  401279:	e8 42 fe ff ff       	call   4010c0 <puts@plt> ;puts(const str1)
  40127e:	83 bd ec fe ff ff 02 	cmpl   $0x2,-0x114(%rbp) 
  401285:	74 2d                	je     4012b4 <main+0x5c>;argc == 2, jmp .L1
  # Return
  ...
  4012bf:	48 8b 00             	mov    (%rax),%rax        ;rax = argv[1]
  4012c2:	be 37 20 40 00       	mov    $0x402037,%esi     ;const str2
  4012c7:	48 89 c7             	mov    %rax,%rdi
  4012ca:	e8 31 fe ff ff       	call   401100 <fopen@plt> ;fopen(argv[1], "str2")
  4012cf:	48 89 45 f8          	mov    %rax,-0x8(%rbp)    ;fp -> rbp-8
  4012d3:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)    ;fp != NULL
  ...
  4012f2:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax  ; rax=&(rbp-272)
  4012f9:	48 89 d1             	mov    %rdx,%rcx    ; rcx=rbp-8=fp
  4012fc:	ba 00 01 00 00       	mov    $0x100,%edx  ; size=256
  401301:	be 01 00 00 00       	mov    $0x1,%esi    ; sizeof(char)
  401306:	48 89 c7             	mov    %rax,%rdi    
  401309:	e8 c2 fd ff ff       	call   4010d0 <fread@plt>
    # fread(&(rbp-272), 1, 256, fp)
  40130e:	48 89 45 f0          	mov    %rax,-0x10(%rbp) ; retval = read_size -> rbp-16(!=0)
  ...
  401336:	48 8d 95 f0 fe ff ff 	lea    -0x110(%rbp),%rdx ; rdx=(char*) base
  40133d:	48 8b 45 f0          	mov    -0x10(%rbp),%rax  ; rax=retval
  401341:	48 01 d0             	add    %rdx,%rax         ; rax = base + read_size = top
  401344:	c6 00 00             	movb   $0x0,(%rax)       ; *top = '\0'
  401347:	48 8b 45 f8          	mov    -0x8(%rbp),%rax   
  40134b:	48 89 c7             	mov    %rax,%rdi         
  40134e:	e8 8d fd ff ff       	call   4010e0 <fclose@plt> ; fclose(fp)
  401353:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax   
  40135a:	48 89 c7             	mov    %rax,%rdi
  40135d:	e8 d0 fe ff ff       	call   401232 <func>  ; func(base)
  401362:	bf 45 20 40 00       	mov    $0x402045,%edi ; const str3
