...
0000000000401216 <func2>:
  ...
  40122c:	74 1e                	je     40124c <func2+0x36> ; edi ?= 0x3f8
...
0000000000401290 <func>:
  ...
  40129c:	48 89 7d e8          	mov    %rdi,-0x18(%rbp)  # base -> rbp-24
  ...
  4012b3:	e8 38 fe ff ff       	call   4010f0 <memcpy@plt> # memcpy(&(rbp-8), base, 56)
...
00000000004012cc <main>:
  ...
  4012db:	89 bd dc fe ff ff    	mov    %edi,-0x124(%rbp) ;argc
  4012e1:	48 89 b5 d0 fe ff ff 	mov    %rsi,-0x130(%rbp) ;argv
  ...
  4012fc:	83 bd dc fe ff ff 02 	cmpl   $0x2,-0x124(%rbp) ;argc=2
  ...
  40135b:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)    ; fp -> rbp-8
  ...
  40137f:	48 8d 85 e0 fe ff ff 	lea    -0x120(%rbp),%rax ; base=rbp-288
  401386:	48 89 d1             	mov    %rdx,%rcx
  401389:	ba 00 01 00 00       	mov    $0x100,%edx 
  40138e:	be 01 00 00 00       	mov    $0x1,%esi         ; read:256*char
  401393:	48 89 c7             	mov    %rax,%rdi
  401396:	e8 15 fd ff ff       	call   4010b0 <fread@plt>
  # fread(base, 1, 256, fp);
  40139b:	48 89 45 f0          	mov    %rax,-0x10(%rbp)  ; read_bytes -> rbp-16
